...
class InputManager {
    ...
    getPlayerInput(_player = 1) {
        ...
        const input = {
            ...
            special1: this.bufferedPress(map.special1),
            special2: this.bufferedPress(map.special2),
            special3: this.bufferedPress(map.special3),
            special4: this.bufferedPress(map.special4),
            teleport: this.bufferedPress(map.teleport),
