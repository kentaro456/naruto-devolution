...
class MinatoFighter extends Fighter {
    constructor(config) {
        ...
        this.comboChains = {
            light: [
                { state: 'ATTACK_LIGHT_1', duration: 26, cancelWindow: [14, 22] },
                { state: 'ATTACK_LIGHT_2', duration: 28, cancelWindow: [16, 24] },
                { state: 'ATTACK_LIGHT_3', duration: 34, cancelWindow: [20, 28] },
            ],
            heavy: [
                { state: 'ATTACK_HEAVY_1', duration: 40, cancelWindow: [26, 34] },
        ...
        this._patchComboNode('L_N_1', {
            profileOverrides: { state: 'ATTACK_LIGHT_1', duration: 26, damageMultiplier: 1.0 },
        });
        this._patchComboNode('L_N_2', {
            profileOverrides: { state: 'ATTACK_LIGHT_2', duration: 28, damageMultiplier: 1.08 },
            routes: { heavy: { neutral: 'H_N_1', forward: 'H_N_1' } },
        });
        this._patchComboNode('L_N_3', {
            profileOverrides: { state: 'ATTACK_LIGHT_3', duration: 34, damageMultiplier: 1.2, knockbackMultiplier: 1.15 },
            routes: { special: { any: 'S_1' } },
        });
        this._patchComboNode('H_N_1', {
            profileOverrides: { state: 'ATTACK_HEAVY_1', duration: 40, damageMultiplier: 1.2, knockbackMultiplier: 1.2 },
            routes: { heavy: { neutral: 'H_N_2' }, special: { any: 'S_1' } },
        });
        this._patchComboNode('H_N_2', {
            profileOverrides: { state: 'ATTACK_HEAVY_2', duration: 48, damageMultiplier: 1.45, knockbackMultiplier: 1.5 },
            routes: { special: { any: 'S_1' } },
        });
    }
}
