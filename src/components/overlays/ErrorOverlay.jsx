...
export function ErrorOverlay({ runtimeError }) {
  return (
    <div className="absolute inset-0 z-40 flex items-center justify-center bg-slate-950 px-4 py-6">
      <div className="w-full max-w-2xl rounded-[32px] border border-rose-300/20 bg-slate-900/84 p-4 shadow-[0_28px_80px_rgba(2,6,23,0.62)] sm:p-6 lg:p-8">
        <div className="font-pixel text-base uppercase tracking-[0.18em] text-rose-300 sm:text-xl">Erreur Runtime</div>
